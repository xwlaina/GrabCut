...
/***********************************************************************/
//由“i->next”来辨别节点i的类型，如果非空则表示其为active节点，如果等于i则表示其为队列的末节点，如果为空且i->parent非空则表示其为passive节点，否则为free节点
/*
...
/***********************************************************************/
//设置某个节点为orphan队列的头部，所有orphan队列中的节点的parent都为常量ORPHAN
template <typename captype, typename tcaptype, typename flowtype> 
...
//设置某个节点为orphan队列的尾部，所有orphan队列中的节点的parent都为常量ORPHAN
template <typename captype, typename tcaptype, typename flowtype> 
